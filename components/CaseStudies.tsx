...
const caseStudiesData = [
  ...
  },
  {
    ...
    clientDescription: "Виробник тротуарної плитки та елементів ландшафтного дизайну.",
    timeframe: "Результат за 3 місяці",
    challenge: "Висока конкуренція в B2C-сегменті. Необхідно було вийти на ландшафтних дизайнерів та забудовників.",
    solution: "Створили візуальну кампанію в Instagram та Pinterest, націлену на архітекторів. Розробили B2B-пропозицію та лід-форми для отримання каталогів.",
    ...
    metrics: [
        ...
        { value: "65 000 грн", label: "Бюджет/міс" },
        { value: "95", label: "Лідів (B2B)" },
        { value: "684 грн", label: "Вартість ліда (CPL)" }
    ],
    visuals: [
      {
        url: "https://images.unsplash.com/photo-1621287042398-92a01ba4d784?q=80&w=400&auto=format&fit=crop",
        caption: "Візуалізація для Pinterest"
      },
      {
        url: "https://images.unsplash.com/photo-1634733302999-a03a4b009b84?q=80&w=400&auto=format&fit=crop",
        caption: "Звіт по B2B лідах"
      }
    ],
    testimonial: {
        ...
        author: "Сергій, засновник 'TerraForma'"
    },
    ltv: {
