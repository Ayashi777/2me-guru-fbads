    ...
    <section id="hero" className="bg-gray-900 text-white relative py-20 md:py-32 overflow-hidden">
      <div className="container mx-auto px-6 text-center relative z-10">
        <h1 className="text-4xl md:text-6xl font-extrabold leading-tight mb-4 animate-fade-in-up">
          Приводимо від 50 до 200 заявок щомісяця на <span className="text-cyan-400">будівництво та ремонт</span>
        </h1>
        <p className="text-lg md:text-xl text-gray-300 max-w-3xl mx-auto mb-8 animate-fade-in-up animation-delay-200">
          Працюємо тільки з будівельним бізнесом. Ви отримуєте клієнтів, а не просто покази реклами.
        </p>
        <a 
          href="#contact" 
        ...
        >
          Порахувати вартість лідів для мого бізнесу
        </a>
