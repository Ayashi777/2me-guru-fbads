    ...
    <div className="bg-gray-800 p-8 rounded-xl border border-gray-700 h-full">
        ...
        <ul className="space-y-4">
            <li className="flex items-start">
                ...
                <span className="text-gray-300">Аналіз вашого бізнесу та конкурентів.</span>
            </li>
            <li className="flex items-start">
                <span className="text-cyan-400 mt-1 mr-3">✓</span>
                <span className="text-gray-300">Покроковий план залучення клієнтів.</span>
            </li>
            <li className="flex items-start">
                <span className="text-cyan-400 mt-1 mr-3">✓</span>
                <span className="text-gray-300">Прогноз бюджету та окупності.</span>
            </li>
             <li className="flex items-start">
                <span className="text-cyan-400 mt-1 mr-3">✓</span>
        ...
        <section id="contact" className="py-20 bg-gray-900">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-extrabold mb-4">Готові отримувати більше клієнтів?</h2>
                    <p className="text-lg text-gray-400 max-w-3xl mx-auto">Заповніть форму, і ми безкоштовно розрахуємо, скільки звернень та за якою ціною ви можете отримувати щомісяця.</p>
                </div>
                            ...
                            <form onSubmit={handleSubmit} className="flex flex-col h-full">
                                ...
                                <div className="mb-6">
                                    <select defaultValue="" required name="service" className="w-full bg-gray-800 border border-gray-700 rounded-lg py-3 px-4 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 appearance-none">
                                        <option value="" disabled>Що вас цікавить?</option>
                                        <option>Реклама в Instagram/Facebook</option>
                                        <option>Реклама в TikTok</option>
                                        <option>Комплексні послуги</option>
                                    </select>
                                </div>
                                <textarea placeholder="Коротко опишіть ваш бізнес (необов'язково)" name="message" rows={4} className="w-full bg-gray-800 border border-gray-700 rounded-lg py-3 px-4 mb-6 text-white focus:outline-none focus:ring-2 focus:ring-cyan-500 flex-grow"></textarea>
                                ...
                                >
                                    {formStatus === 'loading' ? 'Розраховуємо...' : 'Отримати безкоштовний розрахунок'}
                                </button>
                                {formStatus === 'error' && <p className="text-center mt-4 text-red-400">Сталася помилка. Спробуйте, будь ласка, ще раз.</p>}
