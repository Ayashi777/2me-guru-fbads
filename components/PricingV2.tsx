...
const pricingTiers = [
    {
        name: "Старт — для перевірки",
        price: "20000 грн/міс",
        budget: "+ бюджет на рекламу від 10 000 грн",
        description: "Отримайте перші звернення і зрозумійте, які з ваших послуг найкраще продаються через рекламу.",
        features: [
            "Аналіз вашої аудиторії",
            "Запуск 1-2 рекламних оголошень",
            "Створення простих фото/відео",
            "Щотижневий звіт по витратах"
        ],
        cta: "Отримати перші звернення"
    },
    {
        name: "Зростання — стабільний потік клієнтів",
        price: "40000 грн/міс",
        budget: "+ бюджет на рекламу від 25 000 грн",
        isPopular: true,
        description: "Повноцінна система залучення клієнтів, яка забезпечує стабільний потік звернень та зрозумілу аналітику.",
        features: [
            "Все, що в пакеті 'Старт'",
            "Запуск до 5-ти рекламних напрямків",
            "Тестування різних оголошень",
            "Зрозумілі дашборди з аналітикою",
            "Персональний менеджер на зв'язку"
        ],
        cta: "Розрахувати мій прибуток"
    },
    {
        name: "Максимум — для лідерів ринку",
        price: "Індивідуально",
        budget: "Бюджет розраховується індивідуально",
        description: "Комплексні рішення для великих компаній. Домінування в ніші та побудова сильного бренду.",
        features: [
            "Все, що в пакеті 'Зростання'",
        ...
        <section id="pricing" className="py-20 bg-gray-900">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-extrabold mb-4">Скільки коштує стабільний потік клієнтів</h2>
                     <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                        Прозорі тарифи, де ви розумієте, за що платите. Наша оплата + бюджет на кліки в рекламі.
                    </p>
                </div>
                ...
                <div className="text-center mt-16">
                    <h3 className="text-2xl font-bold mb-4">Не знаєте, з чого почати?</h3>
                    <p className="text-gray-400 max-w-xl mx-auto mb-6">Отримайте безкоштовний розрахунок вартості одного звернення та прогноз окупності саме для вашого бізнесу.</p>
