...
// FIX: Corrected import statement for useState and useMemo hooks.
        ...
        <section id="roi-calculator" className="py-20 bg-gray-800/50">
            <div className="container mx-auto px-6">
                <div className="text-center mb-12">
                    <h2 className="text-4xl font-extrabold mb-4">Спрогнозуйте результати від інвестицій в рекламу</h2>
                    <p className="text-lg text-gray-400 max-w-3xl mx-auto">
                        Подивіться, як інвестиції в маркетинг перетворюються на реальні контракти та прибуток для вашого бізнесу.
                    </p>
                </div>
                <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8 items-center bg-gray-900 p-8 rounded-xl border border-gray-700">
                    <div className="space-y-6">
                        <div>
                            <label htmlFor="marketingBudget" className="block text-gray-400 mb-2">Ваш щомісячний бюджет на маркетинг (грн)</label>
                            <input
                                type="range"
                                id="marketingBudget"
                                min="15000"
                        ...
                        <div>
                            <label htmlFor="avgCPL" className="block text-gray-400 mb-2">Прогнозована вартість ліда (CPL, грн)</label>
                             <input
                                type="range"
                                id="avgCPL"
                                min="100"
                    ...
                    <div className="bg-gray-800 p-8 rounded-lg text-center border border-gray-700 h-full flex flex-col justify-center">
                        ...
                        <div className="grid grid-cols-2 gap-x-4 gap-y-6">
                            <div>
                                <p className="text-gray-400 text-sm">Кількість лідів</p>
                            ...
                            <div>
                                <p className="text-gray-400 text-sm">Потенційний дохід</p>
                        ...
                        <div className="mt-8 pt-6 border-t border-gray-700">
                             <p className="text-gray-400 mb-2">Повернення інвестицій (ROMI):</p>
                ...
                <p className="text-center text-sm text-gray-500 mt-8 max-w-3xl mx-auto">
                    *Примітка: Розрахунки є орієнтовними. Наша головна задача — знижувати вартість ліда (CPL) та збільшувати конверсію, щоб максимізувати ваш ROMI.
                </p>
            </div>
        </section>
    );
