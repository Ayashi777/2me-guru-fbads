...
const caseStudiesData = [
  {
    ...
    solution: "Запустили рекламу в Instagram/Facebook на мешканців новобудов. Впровадили просту форму-опитувальник для відсіювання нецікавих запитів.",
    imageUrl: "https://images.unsplash.com/photo-1600585152915-d208bec867a1?q=80&w=800&auto=format&fit=crop",
    metrics: [
      { value: "x5", label: "Окупність вкладень" },
      { value: "48 000 грн", label: "Бюджет/міс" },
      { value: "164", label: "Звернень отримано" },
      { value: "292 грн", label: "Вартість 1 звернення" }
    ],
    visuals: [
      {
        url: "https://images.unsplash.com/photo-1616046229478-9901c5536a45?q=80&w=400&auto=format&fit=crop",
        caption: "Приклад реклами в Instagram"
      },
      {
        url: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=400&auto=format&fit=crop",
        caption: "Зрозумілий звіт по результатах"
      }
    ],
    testimonial: {
      quote: "Ми буквально 'сиділи' на сарафанному радіо, і це було жахливо непередбачувано. З 2Me Guru ми нарешті отримали систему. Тепер я можу спокійно планувати завантаженість бригад на 2-3 місяці вперед, бо знаю, що звернення будуть.",
  ...
  },
  {
    ...
    challenge: "Дуже дорога реклама в Google (>2000 грн за контакт). Звертались люди, які не були готові до покупки.",
    solution: "Створили серію корисних статей у Facebook про етапи будівництва. Спочатку 'прогрівали' людей, а потім пропонували консультацію.",
    imageUrl: "https://images.unsplash.com/photo-1512917774080-9991f1c4c750?q=80&w=800&auto=format&fit=crop",
    metrics: [
      { value: "x8", label: "Окупність вкладень" },
      { value: "90 000 грн", label: "Бюджет/міс" },
      { value: "125", label: "Звернень отримано" },
      { label: "Вартість 1 звернення", before: ">2000 грн", after: "720 грн" }
    ],
    visuals: [
       {
      ...
      },
      {
        ...
        caption: "Приклад звіту по зверненнях"
      }
    ],
    testimonial: {
        quote: "Працював з агенціями, де тебе передають від менеджера до менеджера. 2Me Guru — це інший підхід. Прямий контакт, глибоке розуміння нашого складного продукту, і головне — вони думають про прибуток, а не про 'витрачання бюджету'.",
  ...
  },
  {
    ...
    challenge: "Багато дрібних, нерентабельних замовлень. Треба було вийти на великих дилерів.",
    solution: "Запустили відео-кампанію в TikTok та YouTube, де показували якість продукції. Це підвищило довіру та залучило оптових покупців.",
    imageUrl: "https://images.unsplash.com/photo-1618221118493-71958c35a64a?q=80&w=800&auto=format&fit=crop",
    metrics: [
        { value: "x6", label: "Окупність вкладень" },
        { value: "55 000 грн", label: "Бюджет/міс" },
        { value: "180+", label: "Запитів від дилерів" },
        { value: "305 грн", label: "Вартість 1 запиту" }
    ],
    visuals: [
      {
        url: "https://images.unsplash.com/photo-1611605698335-8b1569810432?q=80&w=400&auto=format&fit=crop",
        caption: "Приклад відео для TikTok"
      },
      {
        url: "https://images.unsplash.com/photo-1551288049-bebda4e38f71?q=80&w=400&auto=format&fit=crop",
                    ...
                    <div className="p-8 space-y-8">
                        ...
                        <div className="grid md:grid-cols-2 gap-6 text-left">
                            <div className="bg-gray-900/50 p-6 rounded-lg">
                               <h4 className="font-semibold text-gray-100 text-lg mb-2">🎯 Яка була проблема:</h4>
                               <p className="text-gray-300">{caseStudy.challenge}</p>
                            </div>
                            <div className="bg-gray-900/50 p-6 rounded-lg">
                               <h4 className="font-semibold text-gray-100 text-lg mb-2">💡 Що ми зробили:</h4>
                               <p className="text-gray-300">{caseStudy.solution}</p>
                            </div>
                        </div>
                        
                        <div>
                          <h4 className="text-xl font-bold text-center mb-4 text-gray-200">Результати в цифрах <span className="text-base font-normal text-gray-400">({caseStudy.timeframe})</span></h4>
                        ...
                        {caseStudy.visuals && caseStudy.visuals.length > 0 && (
                          <div className="pt-2">
                              ...
                              <p className="text-center text-gray-400 mb-6 max-w-lg mx-auto">Ось приклади рекламних оголошень та звітів, які допомогли досягти цих результатів.</p>
                        ...
                        {caseStudy.testimonial && (
                          <div className="border-t border-gray-700 pt-8">
                            <h4 className="text-xl font-bold text-center mb-4 text-gray-200">Що каже клієнт</h4>
    ...
    <section id="case-studies" className="py-20 bg-gray-800/50">
      <div className="container mx-auto px-6">
        <div className="text-center mb-12">
          <h2 className="text-4xl font-extrabold mb-4">Приклади нашої роботи: від звернень до прибутку</h2>
          <p className="text-lg text-gray-400 max-w-2xl mx-auto">Ми не обіцяємо, ми робимо. Подивіться на результати, яких досягли наші клієнти, мовою грошей.</p>
           <p className="text-sm text-gray-500 max-w-2xl mx-auto mt-4">
            *Результати залежать від багатьох факторів. Ці приклади демонструють потенціал нашого підходу при тісній співпраці.
          </p>
        </div>
        <div className="relative">
        ...
        <div className="text-center mt-16">
            <h3 className="text-2xl font-bold mb-4">Хочете так само?</h3>
            <p className="text-gray-400 max-w-xl mx-auto mb-6">Замовте безкоштовний аналіз вашого бізнесу, і ми покажемо, де знаходяться ваші потенційні клієнти.</p>
