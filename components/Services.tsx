...
const servicesData = [
  {
    ...
    description: "Створюємо 'прогрітих' лідів, які вже довіряють вашій якості. Вашим менеджерам не доведеться продавати з нуля."
  },
  {
    icon: <FacebookIcon className="h-12 w-12 text-cyan-400" />,
    title: 'Реклама в Facebook',
    description: 'Знаходимо платоспроможних клієнтів для угод з високим середнім чеком. Скорочуємо час на кваліфікацію ліда.'
  },
  {
    icon: <TikTokIcon className="h-12 w-12 text-cyan-400" />,
    title: 'Реклама в TikTok',
    description: 'Навчаємо аудиторію ще до першого контакту. Ліди приходять з розумінням процесу, що зменшує кількість заперечень.'
  }
];
